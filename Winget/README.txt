...
Os executaveis batch como Administrador iram ignorar as interrupções de sitema para permissões 
de instalção de cada app.

USUARIO LOCAL: executavel ira gravar e procurar o arquivo JSON na mesma pasta do executavel.
